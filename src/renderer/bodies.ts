...
// Pre-rendered 128px Lambert spheres for `display: 3d`, generated once (scripts/gen-sphere-sprites.mjs) and
// inlined so the renderer needs no <canvas> at runtime. SOFT: viewer-lit + high ambient. LIT: in-plane
// light, bright side = local +x, low ambient. Both grayscale+alpha; a per-colour feColorMatrix tints them.
const SPRITE_SOFT =
...
const SPRITE_LIT =
  "data:image/png;base64,";
...
export function renderSphereSprite(
  ...
  const attrs: Record<string, string | number> = {
    href: sunDeg === null ? SPRITE_SOFT : SPRITE_LIT,
    x: x - r,
    y: y - r,
    width: 2 * r,
    height: 2 * r,
  ...
  if (sunDeg !== null) attrs.transform = `rotate(${sunDeg} ${x} ${y})`;
  svg.appendChild(createSvgElement("image", attrs));
}

/** Screen-space bearing from a body to the Sun at CENTER, in degrees; `null` at CENTER. */
export function sunBearing(x: number, y: number): number | null {
  if (x === CENTER && y === CENTER) return null;
...
export function renderBodyShadow(
  ...
  if (d === null) return;
  // The elliptical terminator wash over the core disc — unless the `display: 3d` sprite is
  // already carrying the lit/dark split there (`coreShaded`), in which case only Saturn's
  // ring band below is still wanted.
  if (!coreShaded) {
